...
AOI   = [cos(sawo),sin(sawo),0;-sin(sawo),cos(sawo),0;0,0,1]*...
...
qe    = [ qd(4), qd(3),-qd(2),-qd(1);...
         -qd(3), qd(4), qd(1),-qd(2);...
          ...
          qd(1), qd(2), qd(3), qd(4)]...
          *[s(4);s(5);s(6);s(7)];
wd    =  (2*pi/Torbit)*AIO*[0;0;1];
we    =  [s(1);s(2);s(3)] - wd;
kd    = -0.2;
kp    = -0.02;
Tb    =  kd*I*we + kp*I*qe(1:3);
Tg    =  cross(3*(n^2)*AOB(:,3),I*AOB(:,3));       %GravityGradientTorque due to Moment of inertia
Tc1   =  Tb(1); Td1   = Taerob(1) + Tres(1) + Tg(1) ;
Tc2   =  Tb(2); Td2   = Taerob(2) + Tres(2) + Tg(2);
Tc3   =  Tb(3); Td3   = Taerob(3) + Tres(3) + Tg(3) ;
